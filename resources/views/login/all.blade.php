            ...
            <div class="row justify-content-center align-items-center h-100">
                <div class="col-6">
                    ...
                    <div class="login-form">
                        ...
                        <button type="submit" class="btn btn-dark" style="justify-content: center; width: 290px; margin-bottom: 15px;"> Masuk </button>
                        ...
                        <a style="text-decoration: none; font-weight: bold;"href="register">Register!</a>
                    </div>
                </div>
            </div>
        </div>
