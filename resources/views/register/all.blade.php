                ...
                <div class="col-6">
                    ...
                    <div class="login-form">
                        ...
                        <div class="mb-4" style="outline: none; border: none; padding-top: 20px;">
                            <input type="text" id="nama" name="nama" style="outline: none; font-size: 20px; width: 290px; font-weight border-bottom: 20px;" class="border-0 border-bottom" id="exampleFormControlInput1" placeholder="Nama">
                            @if ($errors->has('nama'))
                        ...
                        <a type="submit" class="btn btn-dark" style="justify-content: center; width: 290px;" href="{{ route('login') }}"> Register </a>
                        <div class="tagnya">
